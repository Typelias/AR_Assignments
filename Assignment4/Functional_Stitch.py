...
#cv2.imshow('First gray',img1_gray)
#cv2.imshow('Second gray',img2_gray)
...
#cv2.imshow('Key point 1',cv2.drawKeypoints(img1, keypoints1, None, (255, 0, 255)))
#cv2.imshow('Key point 2',cv2.drawKeypoints(img2, keypoints2, None, (255, 0, 255)))
...
cv2.imshow('Remaining keypoints 1', cv2.drawKeypoints(
    img1, [keypoints1[m.queryIdx] for m in good], None, (255, 0, 255)))
cv2.imshow('Remaining keypoints 2', cv2.drawKeypoints(
    img2, [keypoints2[m.trainIdx] for m in good], None, (255, 0, 255)))
